...
function $() {
  ...
  (x.useEffect(() => {
    ...
    x.useEffect(() => {
      re.current &&
        t("arc-raiders-blueprints", M, $, "blueprints", {
          progress: M,
        });
    }, [M, $]));
  const de = (e, t) => {
      (t.preventDefault(), t.stopPropagation(), le(e));
    },
    oe = () => {
    ...
    ue = I.filter((e) => {
      if (!H(e.name, B, G.language)) return !1;
      if ("All" !== X && e.category !== X) return !1;
      if ("all" !== U) {
        const t = M[e.id],
          s = (null == t ? void 0 : t.learned) || !1,
          l = ((null == t ? void 0 : t.duplicates) || 0) > 0;
        if ("learned" === U && !s) return !1;
        if ("notLearned" === U && s) return !1;
        if ("owned" === U && !l) return !1;
      }
      return !0;
    }).sort((e, t) => {
      if ("name" === F) {
          ...
          m.jsxs("div", {
            ...
            children: [
              m.jsxs("div", {
                ...
                children: [
                  m.jsx(w, {
                    ...
                    className:
                      "blueprints-filter-search bg-blue-dark border-ui-border",
                  }),
                  m.jsxs("div", {
                    ...
                    children: [
                      m.jsxs(N, {
                        ...
                        children: [
                          m.jsx(k, {
                            className:
                              "bg-blue-dark border-ui-border hover:bg-blue-light",
                            children: m.jsx(S, {
                              placeholder: z(
                            ...
                            children: D.map((e) =>
                              m.jsx(
                                T,
                                {
                                  value: e,
                                  className:
                                    "hover:bg-blue-light focus:bg-blue-light",
                                  children:
                                    "All" === e
                                      ? z("blueprints.filters.allCategories")
                                      : e,
                                },
                                e,
                              ),
                      ...
                      m.jsxs(N, {
                        ...
                        children: [
                          m.jsx(k, {
                            ...
                            children: m.jsxs(S, {
                              children: [
                                "ingame" === F && z("blueprints.sort.ingame"),
                                "name" === F && z("blueprints.sort.name"),
                                "rarity" === F && z("blueprints.sort.rarity"),
                              ],
                            }),
                          }),
                          m.jsxs(C, {
                  ...
                  m.jsxs("div", {
                    ...
                    children: [
                        ...
                        children: [
                          m.jsx(k, {
                            ...
                            children: m.jsxs(S, {
                              children: [
                                "all" === U &&
                                  `${z("blueprints.filters.all")} (${ge.total})`,
                                "learned" === U &&
                                  `${z("blueprints.filters.learned")} (${ge.learned})`,
                                "notLearned" === U &&
                                  `${z("blueprints.filters.notLearned")} (${ge.notLearned})`,
                                "owned" === U &&
                                  `${z("blueprints.filters.owned")} (${ge.owned})`,
                              ],
                            }),
                          }),
                          m.jsxs(C, {
                            ...
                            children: [
                              ...
                              m.jsxs(T, {
                                ...
                                className:
                                  "hover:bg-blue-light focus:bg-blue-light",
                                children: [
                                  z("blueprints.filters.notLearned"),
                                  " (",
                                  ge.notLearned,
                                  ")",
                                ],
                      ...
                      m.jsxs(l, {
                          ...
                          if (ie.current)
                            try {
                              const e = (
                                  await p(async () => {
                                    const { default: e } =
                                      await import("./html2canvas-DVPEA5ss.js");
                                    return {
                                      default: e,
                                    };
                                  }, [])
                                ...
                                l = {
                                  ...
                                  gridGap:
                                    (null == s ? void 0 : s.style.gap) || "",
                                  gridRowGap:
                                    (null == s ? void 0 : s.style.rowGap) || "",
                                };
                              ...
                              const a =
                                  (null == s ? void 0 : s.style.display) || "",
                                n =
                                  (null == s ? void 0 : s.style.gridAutoFlow) ||
                                  "";
                              s &&
                        ...
                        variant: "outline",
                        className:
                          "flex items-center gap-2 h-9 bg-blue-dark border-ui-border hover:bg-blue-light",
                        children: [
                          m.jsx(b, {
                            className: "h-4 w-4",
                          }),
              ...
              m.jsx("div", {
                ref: ie,
                className:
                  "blueprints-grid-container rounded-xl bg-blue-dark/90",
                children: m.jsx("div", {
                  ...
                  children: ue.map((e) => {
                    ...
                    return m.jsx(
                      ...
                      {
                        className:
                          "blueprint-card cursor-pointer group select-none",
                        ...
                        children: m.jsx(W, {
                          ...
                          overlay: m.jsxs(m.Fragment, {
                            children: [
                              l &&
                                m.jsx("div", {
                                  className:
                                    "blueprint-checkmark pointer-events-none",
                                  children: m.jsx("svg", {
                                    className: "w-4 h-4",
                                    fill: "none",
                                    stroke: "#fff",
                              ...
                              a > 0 &&
                                m.jsx("div", {
                                  className:
                                    "blueprint-duplicate pointer-events-none",
                                  children: m.jsx("span", {
                                    className:
                          ...
                          children: m.jsx(r, {
                            ...
                            children: m.jsx(i, {
                              ...
                              size: "lg",
                              showNameBar: !0,
                              displayName: s(e.name, G.language)
                                .replace(/\s*(blueprint|progetto)\s*/gi, "")
                                .trim(),
                              disableHover: !0,
                              onClick: (t) => {
                                (t.stopPropagation(), de(e, t));
                              },
                            }),
                          }),
                        }),
                  ...
                  (() => {
                    ...
                    return m.jsxs(d, {
                      ...
                      children: [
                        m.jsxs("div", {
                          className:
                            "flex items-center gap-4 p-4 pb-3 border-b border-blue-dark/10",
                          children: [
                            m.jsx("div", {
                              className: "shrink-0",
                              children: m.jsx(i, {
                            ...
                            m.jsxs("div", {
                              ...
                              children: [
                                m.jsx("h3", {
                                  className:
                                    "flex text-lg font-bold text-blue-dark uppercase tracking-wide leading-tight truncate",
                                  children: r,
                                }),
                                m.jsxs("div", {
                                  ...
                                  children: [
                                    m.jsx("span", {
                                      className:
                                        "px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-white rounded-sm",
                                      style: {
                                        backgroundColor: l,
                                      },
                                      children: z(
                                        `crafting.rarities.${e.rarity}`,
                                      ),
                                    }),
                                    m.jsx("span", {
                                      className:
                                        "px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-blue-dark/60 bg-blue-dark/10 rounded-sm",
                                      children: e.category,
                                    }),
                                  ],
                                }),
                        ...
                        (e.craftedAt || (e.recipe && e.recipe.length > 0)) &&
                          m.jsxs("div", {
                            className:
                              "px-4 py-3 space-y-2 border-b border-blue-dark/10",
                            children: [
                              e.craftedAt &&
                                m.jsxs("div", {
                                  className:
                                ...
                                m.jsxs("div", {
                                  children: [
                                    ...
                                    m.jsx("div", {
                                      ...
                                      children: e.recipe.map((e, t) =>
                                        m.jsx(
                                          "div",
                                          {
                                            className:
                                              "text-sm text-blue-dark bg-blue-dark/5 rounded px-2.5 py-1.5",
                                            children: e,
                                          },
                                          t,
                                        ),
                        ...
                        m.jsxs("div", {
                          className:
                            "flex items-center justify-between px-4 py-3 border-b border-blue-dark/10",
                          children: [
                            m.jsx("span", {
                              className:
                                "text-sm text-blue-dark/70 uppercase tracking-wide font-medium",
                            ...
                            m.jsxs("div", {
                              ...
                              children: [
                                m.jsx("button", {
                                  ...
                                  className:
                                    "w-9 h-9 rounded-lg bg-blue-dark/10 flex items-center justify-center text-blue-dark hover:bg-blue-dark/20 transition-colors disabled:opacity-30 disabled:cursor-not-allowed",
                                  children: m.jsx(f, {
                                    size: 18,
                                  }),
                                }),
                                m.jsx("span", {
                                  className:
                                    "text-xl font-bold text-blue-dark min-w-[2ch] text-center",
                                ...
                                m.jsx("button", {
                                  ...
                                  className:
                                    "w-9 h-9 rounded-lg bg-gold-accent flex items-center justify-center text-blue-dark hover:brightness-110 transition-all disabled:opacity-30 disabled:cursor-not-allowed",
                                  children: m.jsx(y, {
                                    size: 18,
                                  }),
                                }),
