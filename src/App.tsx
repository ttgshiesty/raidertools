...
const CraftCalculatorApp = lazy(() =>
  import('./apps/craft-calculator').then((m) => ({
    default: m.CraftCalculatorApp,
  })),
);
...
const QuartermasterApp = lazy(() =>
  import('./apps/quartermaster').then((m) => ({
    default: m.QuartermasterApp,
  })),
);

const StatsApp = lazy(() =>
  import('./apps/stats').then((m) => ({ default: m.default })),
);

const BlueprintsApp = lazy(() =>
  import('./apps/blueprints').then((m) => ({
    default: m.BlueprintsApp,
  })),
);

const MarketApp = lazy(() =>
  import('./apps/market').then((m) => ({ default: m.MarketApp })),
);

const SkillTreeApp = lazy(() =>
  import('./apps/skill-tree').then((m) => ({
    default: m.SkillTreeApp,
  })),
);
