import {g as t, c as i} from "./vendor-IfRri_3N.js";
var e = {};
!function(t) {
    function i(t) {
        var i, e, n, o;
    ...
    var G, K = i({}, W, {
        code: "EPSG:3857",
        projection: U,
        transformation: (G = .5 / (Math.PI * U.R),
        q(G, .5, -G, .5))
    }), Y = i({}, K, {
        code: "EPSG:900913"
    });
    ...
    var $, Q = document.documentElement.style, tt = "ActiveXObject"in window, it = tt && !document.addEventListener, et = "msLaunchUri"in navigator && !("documentMode"in document), nt = At("webkit"), ot = At("android"), st = At("android 2") || At("android 3"), rt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), at = ot && At("Google") && rt < 537 && !("AudioNode"in window), ht = !!window.opera, lt = !et && At("chrome"), ut = At("gecko") && !nt && !ht && !tt, ct = !lt && At("safari"), _t = At("phantom"), dt = "OTransition"in Q, pt = 0 === navigator.platform.indexOf("Win"), mt = tt && "transition"in Q, ft = "WebKitCSSMatrix"in window && "m11"in new window.WebKitCSSMatrix && !st, gt = "MozPerspective"in Q, vt = !window.L_DISABLE_3D && (mt || ft || gt) && !dt && !_t, yt = "undefined" != typeof orientation || At("mobile"), xt = yt && nt, wt = yt && ft, bt = !window.PointerEvent && window.MSPointerEvent, Pt = !(!window.PointerEvent && !bt), Lt = "ontouchstart"in window || !!window.TouchEvent, Tt = !window.L_NO_TOUCH && (Lt || Pt), Mt = yt && ht, zt = yt && ut, Ct = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Zt = function() {
        var t = !1;
        try {
        ...
        return t
    }(), St = !!document.createElement("canvas").getContext, Et = !(!document.createElementNS || !X("svg").createSVGRect), kt = !!Et && (($ = document.createElement("div")).innerHTML = "<svg/>",
    "http://www.w3.org/2000/svg" === ($.firstChild && $.firstChild.namespaceURI)), Ot = !Et && function() {
        try {
    ...
    var Bt = {
      ...
      , Ht = {
        touchstart: function(t, i) {
            i.MSPOINTER_TYPE_TOUCH && i.pointerType === i.MSPOINTER_TYPE_TOUCH && Ni(i),
            Kt(t, i)
        },
        touchmove: Kt,
        touchend: Kt,
      ...
      , Ft = !1;
    function Ut(t, i, e) {
        return "touchstart" === i && (Ft || (document.addEventListener(It, Vt, !0),
        document.addEventListener(Rt, qt, !0),
        document.addEventListener(Nt, Gt, !0),
        document.addEventListener(Dt, Gt, !0),
        Ft = !0)),
        Ht[i] ? (e = Ht[i].bind(this, e),
        t.addEventListener(jt[i], e, !1),
        e) : h
    }
    function Vt(t) {
        Wt[t.pointerId] = t
    ...
    var Yt, Xt, Jt, $t, Qt, ti = fi(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]), ii = fi(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]), ei = "webkitTransition" === ii || "OTransition" === ii ? ii + "End" : "transitionend";
    function ni(t) {
    ...
    function gi(t, i, e) {
        var n = i || new E(0,0);
        t.style[ti] = (Bt.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (e ? " scale(" + e + ")" : "")
    }
    function vi(t, i) {
        t._leaflet_pos = i,
        Bt.any3d ? gi(t, i) : (t.style.left = i.x + "px",
        t.style.top = i.y + "px")
    }
    function yi(t) {
    ...
    if ("onselectstart"in document)
        ...
        ,
        Xt = function() {
            xi && (document.documentElement.style[xi] = Jt,
            Jt = void 0)
        }
    }
    function wi() {
    ...
    function Oi(t, i, e, n) {
        ...
        var r = function(i) {
          ...
          , a = r;
        !Bt.touchNative && Bt.pointer && 0 === i.indexOf("touch") ? r = Ut(t, i, r) : Bt.touch && "dblclick" === i ? r = function(t, i) {
        ...
        }(t, r) : "addEventListener"in t ? "touchstart" === i || "touchmove" === i || "wheel" === i || "mousewheel" === i ? t.addEventListener(ki[i] || i, r, !!Bt.passiveEvents && {
            passive: !1
        ...
        ,
        t.addEventListener(ki[i], r, !1)) : t.addEventListener(i, a, !1) : t.attachEvent("on" + i, r),
        t[Zi] = t[Zi] || {},
        t[Zi][o] = r
    }
    function Ai(t, i, e, n, o) {
        ...
        if (!r)
            return this;
        !Bt.touchNative && Bt.pointer && 0 === i.indexOf("touch") ? function(t, i, e) {
            jt[i] && t.removeEventListener(jt[i], e, !1)
        }(t, i, r) : Bt.touch && "dblclick" === i ? function(t, i) {
            t.removeEventListener("dblclick", i.dblclick),
            t.removeEventListener("click", i.simDblclick)
        }(t, r) : "removeEventListener"in t ? t.removeEventListener(ki[i] || i, r, !1) : t.detachEvent("on" + i, r),
        t[Zi][o] = null
    }
    function Bi(t) {
    ...
    function Ii(t) {
        return Oi(t, "wheel", Bi),
        this
    }
    function Ri(t) {
        return Ci(t, "mousedown touchstart dblclick contextmenu", Bi),
    ...
    var Wi = Bt.linux && Bt.chrome ? window.devicePixelRatio : Bt.mac ? 3 * window.devicePixelRatio : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
    function Fi(t) {
        return Bt.edge ? t.wheelDeltaY / 2 : t.deltaY && 0 === t.deltaMode ? -t.deltaY / Wi : t.deltaY && 1 === t.deltaMode ? 20 * -t.deltaY : t.deltaY && 2 === t.deltaMode ? 60 * -t.deltaY : t.deltaX || t.deltaZ ? 0 : t.wheelDelta ? (t.wheelDeltaY || t.wheelDelta) / 2 : t.detail && Math.abs(t.detail) < 32765 ? 20 * -t.detail : t.detail ? t.detail / -32765 * 60 : 0
    }
    function Ui(t, i) {
    ...
    var Vi = {
      ...
      , Gi = S.extend({
        ...
        initialize: function(t, i) {
            ...
            this.callInitHooks(),
            this._zoomAnimated = ii && Bt.any3d && !Bt.mobileOpera && this.options.zoomAnimation,
        ...
        zoomIn: function(t, i) {
            return t = t || (Bt.any3d ? this.options.zoomDelta : 1),
        ...
        panBy: function(t, i) {
            ...
            if (!0 !== i.animate && !this.getSize().contains(t))
                ...
                this;
            if (this._panAnim || (this._panAnim = new qi,
            this._panAnim.on({
        ...
        _initLayout: function() {
            ...
            ci(t, "leaflet-container" + (Bt.touch ? " leaflet-touch" : "") + (Bt.retina ? " leaflet-retina" : "") + (Bt.ielt9 ? " leaflet-oldie" : "") + (Bt.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
            var i = oi(t, "position");
        ...
        _initEvents: function(t) {
            ...
            Bt.any3d && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd)
        },
        _onResize: function() {
    ...
    var Xi = Ki.extend({
        ...
        addTo: function(t) {
            return Ki.prototype.addTo.call(this, t),
    ...
    Gi.addInitHook(function() {
        this.options.zoomControl && (this.zoomControl = new Ji,
    ...
    var $i = Ki.extend({
      ...
      , Qi = Ki.extend({
        options: {
            ...
            prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (Bt.inlineSvg ? '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg> ' : "") + "Leaflet</a>"
        },
        initialize: function(t) {
            _(this, t),
            this._attributions = {}
    ...
    var ie = {
      ...
      , ne = S.extend({
        ...
        enable: function() {
            this._enabled || (Ci(this._dragStartTarget, ee, this._onDown, this),
            this._enabled = !0)
        },
        disable: function() {
            this._enabled && (ne._dragging === this && this.finishDrag(!0),
        ...
        _onDown: function(t) {
            ...
            !ui(this._element, "leaflet-zoom-anim")))
                ...
                else if (!(ne._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (ne._dragging = this,
                ...
                this._moving))) {
                    ...
                    Ci(document, n ? "mousemove" : "touchmove", this._onMove, this),
                    Ci(document, n ? "mouseup" : "touchend touchcancel", this._onUp, this)
                }
        },
        _onMove: function(t) {
            if (this._enabled)
    ...
    function oe(t, i, e) {
        ...
        for (r = 0; r < 4; r++) {
            ...
            s = (l = t.length) - 1; o < l; s = o++)
                a = t[o],
                h = t[s],
                a._code & u ? h._code & u || ((c = de(h, a, u, i, e))._code = pe(c, i),
                n.push(c)) : (h._code & u && ((c = de(h, a, u, i, e))._code = pe(c, i),
                n.push(c)),
                n.push(a));
            t = n
        }
    ...
    function se(t, i) {
        ...
        var c = D([0, 0])
          , _ = R(t);
        _.getNorthWest().distanceTo(_.getSouthWest()) * _.getNorthEast().distanceTo(_.getNorthWest()) < 1700 && (c = re(t));
        var d = t.length
          , p = [];
        for (e = 0; e < d; e++) {
            var m = D(t[e]);
    ...
    function _e(t, i, e, n, o) {
        var s, r, a, h = n ? ae : pe(t, e), l = pe(i, e);
        for (ae = l; ; ) {
            if (!(h | l))
                return [t, i];
            if (h & l)
    ...
    function ye(t, i) {
        ...
        var u = D([0, 0])
          , c = R(t);
        c.getNorthWest().distanceTo(c.getSouthWest()) * c.getNorthEast().distanceTo(c.getNorthWest()) < 1700 && (u = re(t));
        var _ = t.length
          , d = [];
        for (e = 0; e < _; e++) {
            var p = D(t[e]);
    ...
    var Ee = Se.extend({
        ...
        _getIconUrl: function(t) {
            return "string" != typeof Ee.imagePath && (Ee.imagePath = this._detectIconPath()),
            (this.options.imagePath || Ee.imagePath) + Se.prototype._getIconUrl.call(this, t)
        },
      ...
      , Oe = ze.extend({
        ...
        _initIcon: function() {
            ...
            this.options.autoPanOnFocus && Ci(e, "focus", this._panOnFocus, this);
        ...
        _removeIcon: function() {
            ...
            this.options.autoPanOnFocus && Si(this._icon, "focus", this._panOnFocus, this),
            ri(this._icon),
        ...
        _initInteraction: function() {
            if (this.options.interactive && (ci(this._icon, "leaflet-interactive"),
    ...
    var Ae = ze.extend({
      ...
      , Be = Ae.extend({
        ...
        setStyle: function(t) {
            ...
            return Ae.prototype.setStyle.call(this, t),
            this.setRadius(i),
            this
        },
        _project: function() {
    ...
    function je(t, i) {
        ...
        case "MultiLineString":
            return n = Fe(a, "LineString" === r.type ? 0 : 1, u),
            new Re(n,i);
        case "Polygon":
        case "MultiPolygon":
            return n = Fe(a, "Polygon" === r.type ? 1 : 2, u),
            new Ne(n,i);
    ...
    var tn = ze.extend({
        ...
        onAdd: function(t) {
            ...
            this.bringToFront(),
            this.options.interactive && (ci(this._container, "leaflet-interactive"),
            this.addInteractiveTarget(this._container))
        },
        onRemove: function(t) {
            t._fadeAnimated ? (mi(this._container, 0),
            this._removeTimeout = setTimeout(n(ri, void 0, this._container), 200)) : ri(this._container),
            this.options.interactive && (_i(this._container, "leaflet-interactive"),
    ...
    var en = tn.extend({
        ...
        _initLayout: function() {
            ...
            if (this._contentNode = si("div", t + "-content", e),
            Ri(i),
    ...
    Gi.include({
        openPopup: function(t, i, e) {
            return this._initOverlay(en, t, i, e).openOn(this),
            this
        },
    ...
    ze.include({
        bindPopup: function(t, i) {
            return this._popup = this._initOverlay(en, this._popup, t, i),
        ...
        openPopup: function(t) {
            return this._popup && (this instanceof Ze || (this._popup._source = this),
        ...
        _openPopup: function(t) {
            if (this._popup && this._map) {
                ...
                this._popup._source !== i || i instanceof Ae ? (this._popup._source = i,
    ...
    Gi.include({
        openTooltip: function(t, i, e) {
            return this._initOverlay(nn, t, i, e).openOn(this),
            this
        },
    ...
    ze.include({
        ...
        openTooltip: function(t) {
            return this._tooltip && (this instanceof Ze || (this._tooltip._source = this),
    ...
    var on = Se.extend({
        ...
        createIcon: function(t) {
            var i = t && "DIV" === t.tagName ? t : document.createElement("div")
              , e = this.options;
            if (e.html instanceof Element ? (ai(i),
    ...
    var sn = ze.extend({
        ...
        _initTile: function(t) {
            ...
            t.onselectstart = h,
            t.onmousemove = h,
            Bt.ielt9 && this.options.opacity < 1 && mi(t, this.options.opacity)
        },
        ...
        _tileReady: function(t, i, e) {
            ...
            this.fire("load"),
            Bt.ielt9 || !this._map._fadeAnimated ? T(this._pruneTiles, this) : setTimeout(n(this._pruneTiles, this), 250)))
        },
    ...
    var rn = sn.extend({
        ...
        initialize: function(t, i) {
            this._url = t,
            (i = _(this, i)).detectRetina && Bt.retina && i.maxZoom > 0 ? (i.tileSize = Math.floor(i.tileSize / 2),
        ...
        createTile: function(t, i) {
            ...
            return Ci(e, "load", n(this._tileOnLoad, this, i, e)),
      ...
      , un = ln.extend({
        ...
        _handleMouseHover: function(t, i) {
            if (!this._mouseHoverThrottled) {
                ...
                o && (ci(this._container, "leaflet-interactive"),
    ...
    var _n = function() {
      ...
      , dn = {
        ...
        _updateStyle: function(t) {
            ...
            o.stroked = !!n.stroke,
            o.filled = !!n.fill,
            n.stroke ? (i || (i = t._stroke = _n("stroke")),
            o.appendChild(i),
    ...
    var Pn = te.extend({
        ...
        _onDown: function(t) {
            ...
            1 === t.touches.length) {
                ...
                this._holdTimeout = setTimeout(n(function() {
                    this._cancel(),
                    this._isTapValid() && (Ci(document, "touchend", Ni),
                    Ci(document, "touchend touchcancel", this._cancelClickPrevent),
        ...
        _cancel: function() {
            ...
            Si(document, "touchend touchcancel contextmenu", this._cancel, this),
